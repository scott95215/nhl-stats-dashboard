...
import { ChevronDown, ChevronUp, Info, TrendingUp, Shield, BarChart3 } from 'lucide-react';
...
export default function Methodology() {
  ...
  return (
    <div className="methodology-section">
      ...
      >
        <Info size={18} />
        <span>How We Calculate Momentum Score</span>
      ...
      {isOpen && (
        <div className="methodology-content">
          <div className="method-card">
            ...
            <ul>
              <li>We analyze the top 50 point leaders in the league</li>
              <li>For each player, we calculate their PPG over the last N games</li>
              <li>Higher PPG = Higher momentum score</li>
            </ul>
            <div className="formula">
              Momentum = Total Points / Games Played
            </div>
          </div>
          ...
          <div className="method-card">
            <div className="method-header">
              <Shield size={20} />
              <h3>Goalie Momentum</h3>
            </div>
            <p>Goalie momentum uses a weighted formula combining three key metrics:</p>
            <ul>
            ...
            <div className="formula">
              Momentum = (SV% x 0.5) + ((1 - GAA/5) x 0.3) + (Win% x 0.2)
            </div>
          </div>
          ...
          <div className="method-card">
            ...
            <p>Team momentum combines recent win percentage with goal differential:</p>
            <ul>
            ...
            <div className="formula">
              Momentum = (Win% x 0.6) + (Normalized GD x 0.4)
            </div>
          ...
          <div className="methodology-note">
            ...
            Data refreshes every 5 minutes from the official NHL API. Today's games and live Oilers games refresh every 30 seconds.
